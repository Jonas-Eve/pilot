...
LABELS=(
  ...
  "type:bug|D93F0B|PILOT: defect in already-shipped code, classified/originated by the architect; always level:task, skips phase 2 entirely"
  "type:e2e|FBCA04|PILOT: mandatory end-to-end-test task on every type:feature split, originated by the architect; routes phase 4 to pilot-e2e"
  ...
  "level:task|C2C2C2|PILOT: a dev-sized unit of a status:split story, or a standalone type:bug ticket with no parent; never itself split further"
  ...
  "status:split|D4C5F9|PILOT: split into tasks (mandatory for type:feature, a size judgment for type:tech; type:bug never reaches this, always a task itself); tracks its own tasks"
  ...
  "status:done|0E8A16|PILOT: merged, completed by cascade from a status:split parent's tasks, or confirmed by phase 6 human QA"
