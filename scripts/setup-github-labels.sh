...
LABELS=(
  ...
  "level:task|C2C2C2|PILOT: a dev-sized unit of a status:split story; never itself split further"
  ...
  "status:split|D4C5F9|PILOT: split into tasks (mandatory for type:feature, a size judgment for type:tech/type:bug); tracks its own tasks"
