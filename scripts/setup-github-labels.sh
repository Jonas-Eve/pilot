...
LABELS=(
  "type:feature|1D76DB|PILOT: functional user story, formalized in Discovery (phase 1) by PM+architect"
  "type:tech|0E8A16|PILOT: technical need, formalized in Discovery alongside a feature, or standalone via Spec"
  "type:bug|D93F0B|PILOT: defect in shipped code, classified by the architect via Spec's own entry; always level:task, never splits"
  "type:e2e|FBCA04|PILOT: mandatory end-to-end task on every type:feature split; routes phase 3 to pilot-e2e"
  "level:epic|5319E7|PILOT: always type:feature; groups several level:story tickets by theme; never scoped/spec'd/built itself"
  "level:story|BFD4F2|PILOT: the root unit Discovery (or Spec's standalone tech entry) produces; may stay unsplit or become status:split"
  "level:task|C2C2C2|PILOT: dev-sized unit of a status:split story, or a standalone type:bug ticket; never split further"
  "priority:P0|B60205|PILOT: highest priority, initial value at creation (PM/architect), revised at Spec"
  "priority:P1|D93F0B|PILOT: medium priority, initial value at creation (PM/architect), revised at Spec"
  "priority:P2|FBCA04|PILOT: lowest priority, initial value at creation (PM/architect), revised at Spec"
  "status:draft|C5DEF5|PILOT: Discovery, or Spec's own no-ticket entry, created the ticket, awaiting final human approval in pair mode"
  "status:backlog|BFD4F2|PILOT: ticket formalized, Spec (phase 2) hasn't started"
  "status:in-spec|C5DEF5|PILOT: architect+tech lead have claimed it for phase 2 (split and spec, one continuous pass)"
  "status:dev-ready|BFD4F2|PILOT: split (if any) and spec written, ready for phase 3"
  "status:in-dev|C5DEF5|PILOT: a dev has claimed it for phase 3"
  "status:review-ready|BFD4F2|PILOT: a PR is open, ready for phase 4 to claim"
  "status:in-review|C5DEF5|PILOT: phase 4 has claimed it and is running (or blocked)"
  "status:changes-requested|F9D0C4|PILOT: phase 4 found at least one blocking, code-level point"
  "status:approved|0E8A16|PILOT: phase 4 ran, every reviewer approved, ready to merge"
  "status:wont-do|E4E669|PILOT: concluded (Discovery or Spec) this ticket shouldn't be built"
  "status:split|D4C5F9|PILOT: split into tasks (mandatory for type:feature, judgment call for type:tech); tracks its tasks"
  "status:qa|FBCA04|PILOT: type:feature story whose tasks are all done; ready for phase 5 human QA"
  "status:in-qa|C5DEF5|PILOT: pilot-qa has claimed it for phase 5"
  "status:done|0E8A16|PILOT: merged, via cascade from a status:split parent's tasks, or confirmed by phase 5 QA"
