...
- **Code quality/maintainability** — readability/naming, whether tests actually exercise
  ...
  implementation commit(s) that fix it (`docs/pilot-task-implement.md` step 3). If the
  ...
  design (`docs/pilot-task-implement-e2e.md`) — judge them instead on whether the test
  ...
  diff before opening the PR (`docs/pilot-process.md` §4 "Interaction modes"), so your
