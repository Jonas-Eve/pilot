...
prerequisite tech ticket (`.pilot/pilot-process.md` §2 "Prerequisite tech tickets") but
...
(`.pilot/pilot-process.md` §2 "Three levels" — a bug never goes through phase 2's own
